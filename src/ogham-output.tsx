...
export class OghamOutput extends Component<OghamOutputProps, OghamOutputState> {
  ...
  shareViaTwitter() {
    const text = `I created the ogham string ${this.getTextAsOgham()}, which means "${
  ...
  shareViaLinkedIn() {
    ...
    const summary = `I created the ogham string ${this.getTextAsOgham()} - it means "${
      this.state.plaintext
    }". Try it yourself on https://ogh.am`;
  ...
  render(props: OghamOutputProps, state: OghamOutputState) {
    return (
      <div class="center">
        ...
        <p class="center">
          Use the download button to obtain a high-quality image of your Ogham.
        </p>
        <div class="row">
